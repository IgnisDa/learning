...
use iron::{
    headers::ContentType, status, AfterMiddleware, BeforeMiddleware, Handler, IronResult, Request,
    Response,
};
use router::Router;
...
use crate::{database::Database, models::Post};
